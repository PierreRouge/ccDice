...
dir_res = 'res/xp3_20/full_res.csv'
...
ax2 = plt.twinx()
ax2 = sns.lineplot(data=df_2, x="nb_disconnections", y="Score", hue="Metric", errorbar='sd', err_style='band', estimator='mean', marker='o', linewidth = 1, palette=palette2, legend=False)
